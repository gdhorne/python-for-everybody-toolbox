...
###############################################################################
# Python for Everyone Toolbox for Python for Everyone Specialization          #
#                                                                             #
...
function display_banner() {
	...
	echo
	echo "Python for Everyone Toolbox for 'Python for Everyone Specialization'"
	echo "version 0.1, Copyright (C) 2016 Gregory D. Horne"
	echo
	echo "Python for Everyone Toolbox comes with ABSOLUTELY NO WARRANTY;"
	echo "for details read the LICENSE file."
	echo "This is free software, and you are welcome to redistribute it"
	echo "under certain conditions; read the LICENSE for details."
	echo
	echo "Further informmation about the Python for Everyone Specialization"
	echo "offered by University of Michigan as a Massively Open-Online"
	echo "Course (MOOC) using the Coursera platform can be found at"
	echo -e "\n\tPython for Everyone Specialization"
	echo -e "\t\thttps://www.coursera.org/specializations/python"
	echo -e "\n\tCoursera\n\t\thttps://coursera.org"
	echo
	echo "This software and associated documentation has been developed"
	echo "independently of University of Michigan and Coursera. It is"
	echo "provided as a convenience to participants in the Python for Everyone"
	echo "Specalization."
	echo
	echo
}
